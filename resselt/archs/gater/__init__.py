    ...
    def __init__(self):
        super().__init__(
            ...
            detect=KeyCondition.has_all(
                ...
                'latent.1.gated.0.conv.focusing_factor',
                'latent.1.gated.0.conv.scale',
                'latent.1.gated.0.conv.q.weight',
                'latent.1.gated.0.conv.q.bias',
                'latent.1.gated.0.conv.kv.weight',
                'latent.1.gated.0.conv.kv.bias',
                'latent.1.gated.0.conv.proj.weight',
                'latent.1.gated.0.conv.proj.bias',
                'latent.1.gated.0.conv.dwc.weight',
                'latent.1.gated.0.conv.dwc.bias',
