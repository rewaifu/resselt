# https://github.com/chaiNNer-org/spandrel/blob/main/libs/spandrel/spandrel/util/__init__.py
import math
...
class HATArch(Architecture[HAT]):
    ...
    def load(self, state_dict: Mapping[str, object]):
        ...
        return self._enhance_model(model=model, in_channels=in_chans, out_channels=in_chans, upscale=upscale, name='HAT')
